    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(LoginActivity.this,RegisterEducation.class);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                returnCode=SyncHttpUtil.sendOkHttpRequest("http://49.140.124.219:8081/myApplication/LoginServlet",mEmail,mPassword);
            } catch (Exception e) {
                returnCode="-3";//超时异常
                return false;
            }
            ...
            if(returnCode!=null&&!(returnCode.equals("0")||returnCode.equals("1")||returnCode.equals("2")||returnCode.equals("3"))){
                return false;
            }else{
            ...
            if (success) {
                ...
                if(returnCode.equals("-2")){
                    LoginActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(LoginActivity.this,R.string.error_MySQL,Toast.LENGTH_LONG).show();
                        }
                    });
                }
